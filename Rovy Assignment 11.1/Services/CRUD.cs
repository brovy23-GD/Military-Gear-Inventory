...
// CRUD is the service layer used by the WPF window for database operations.
// It follows the same structure as the class example shown in class.
public class CRUD : ICRUD
{
    ...
    public void UpdateGearItem(GearItem gearItem)
    {
        ...
        // Find the existing row first so we only update an item that already exists.
